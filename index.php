    ...
    <ul class="uk-slideshow-items">
      ...
      <li class="uk-animation-fade ">
        ...
        <div class="uk-position-center-left">
            ...
            <h2 class="secondary-font uk-margin-bottom-small" uk-scrollspy="cls: unimation-fade;  delay: 300; repeat: false ">You are in Safe Hands! </h2>
...
<div id="about" class="uk-section  uk-section-primary" style="background-color: #526178;">
  <div class="uk-container">
    ...
    <div class="">
        <div class="uk-height-1-1 uk-background-center-center uk-background-cover uk-background-norepeat uk-background-blend-overlay 
          ...
          <img class="uk-box-shadow-large" src="https://thumbs.dreamstime.com/b/building-blue-letter-h-sign-hospital-large-modern-184908229.jpg" alt="About Us">
        </div>
      </div> 
      <div class="uk-first-column ">
        <div class=" uk-flex uk-flex-column">
          <h1 class="secondary-font">About Hospital</h1>
